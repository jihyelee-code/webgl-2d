...
ObjectPainter.prototype = {
   ...
   */
    createLocations: function (locationNames) {
        ...
        const barycentricLocation = this.gl.getAttribLocation(this.program, locationNames.aBarycentric);
    ...
    */
    ...
    drawScene: function () {
        ...
        // 7-1.turn the attribute on
        this.gl.enableVertexAttribArray(this.location.barycentricLocation);

        // 7-2. set bind buffer
        this.gl.bindBuffer(this.gl.ARRAY_BUFFER, this.barycentricBuffer);
        ...
        // 7-3.tell how to get data out of positionBuffer
        {
            ...
            //'vertexAttribPointer' binds the 'current ARRAY_BUFFER' to the attribute.
            //so this attribute is bound to 'positionBuffer'
            this.gl.vertexAttribPointer(this.location.barycentricLocation, size, type, normalize, stride, offset);
        }
